...
#define STR_CST_gcc_first_not_supported "10.0.0"
...
#define STR_CST_gcc_supported_versions  \
   ...
   "4.5.2 4.5.3 4.5.4 " \
   "4.6.1 4.6.3 4.6.4 " \
   "4.7.0 4.7.2 4.7.3 4.7.4 " \
   "4.8.0 4.8.1 4.8.2 4.8.3 4.8.4 4.8.5 " \
   "4.9.0 4.9.1 4.9.2 4.9.3 4.9.4 " \
   "5.1.0 5.1.1 5.2.0 5.2.1 5.3.0 5.3.1 5.4.0 5.4.1 5.5.0 " \
   "6.0.0 6.2.0 6.2.1 6.3.0 6.4.0 6.5.0 " \
   "7.0.1 7.1.0 7.3.0 7.4.0 7.5.0 " \
   "8.0.1 8.2.0 8.2.1 8.3.0 8.3.1 8.4.0 8.5.0 " \
